...
import com.example.batch2.demo.models.Designation;
import com.example.batch2.demo.repository.CustomerRepository;
...
public class BatchConfiguration {
    ...
    @Bean
    public Step nameStep(StepBuilderFactory stepBuilderFactory, ItemReader<Customer> csvReader, NameProcessor processor, CustomerWriter writer) {
        ...
        @Bean
        public Step designationStep(StepBuilderFactory stepBuilderFactory, ItemReader<Customer> repositoryReader, DesignationProcessor processor, CustomerWriter writer) {
            ...
            return stepBuilderFactory.get("designation-step")
                    ...
                    .faultTolerant()
                    .retryLimit(3)
                    .retry(NoSuchMethodException.class)
                    .allowStartIfComplete(true)
                    .build();
        }
            ...
            public FlatFileItemReader<Customer> csvReader (@Value("${inputFile}") String inputFile){
                return new FlatFileItemReaderBuilder<Customer>()
                        ...
                        .delimited()
                        .names("id", "first_name", "last_name", "email", "phone", "designation")
                        .linesToSkip(1)
            ...
            public static class DesignationProcessor implements ItemProcessor<Customer, Customer> {
                ...
                @Override
                public Customer process(Customer customer) {
                    customer.setDesignation(Designation.getByCode(customer.getDesignation()).getCustomerType());
